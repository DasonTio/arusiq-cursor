...
D7 §4.1 says *"Severity borrows the state fills"* and maps:
...
Severity therefore renders as D7 §3.2's own *preferred* pattern: **10 % tint +
...
*and placeholders*". At 4.00:1 a placeholder is below the 4.5:1 text bar.
...
D7 already argues that *brand red ≠ state red* because the two carry different
...
- D7 §4.1's colour mapping is superseded. Its *vocabulary* — four levels, three
